(function(root){
  ...
  const INTERIORS=['Essentiel','Essentielle','Éveil des sens','Art de vivre','Carte Blanche','Éveil des Sens','Art de Vivre'];
  const GARDENS=['Essentiel','Essentielle','Horizon','Art de vivre','Carte Blanche','Éclosion','Art de Vivre'];
