(function () {
  ...
  var css = `
    ...
    .sf-logo img{height:120px;width:auto;display:block;margin-bottom:.6rem}
    ...
    @media(max-width:900px){footer.sf{padding:3.5rem 1.5rem 2rem}.sf-inner{grid-template-columns:1fr 1fr}.sf-brand{grid-column:1/-1}.sf-logo img{height:100px}}
    @media(max-width:620px){.sf-inner{grid-template-columns:1fr;gap:2rem}.sf-brand{grid-column:auto}.sf-bottom{align-items:flex-start;flex-direction:column}.sf-logo img{height:88px}}
  `;

  var html = ''
    + '<footer class="sf">'
    +   '<div class="sf-inner">'
    +     '<div class="sf-brand"><a href="index.html" class="sf-logo"><img src="assets/logo-full.svg" alt="Latitude Samui — Luxury Homes Koh Samui"></a><p>Villas contemporaines à Koh Samui.<br>Une collection limitée, construite et accompagnée directement.</p></div>'
